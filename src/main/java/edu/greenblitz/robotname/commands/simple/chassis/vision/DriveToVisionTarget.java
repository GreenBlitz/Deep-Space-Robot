...
public class DriveToVisionTarget extends ChassisBaseCommand {
    ...
    protected void initialize() {
        ...
        m_controller.configurePID(DRIVE_IDX, inputDrive, 0, -1, 1, 0);
        m_controller.configurePID(TURN_IDX, inputTurn, 0, -1, 1, 0);
    }
    ...
    protected boolean isFinished() {
        ...
        var inputDrive = state.getPlaneryDistance();
        var inputTurn = VisionMaster.getInstance().getStandardizedData().getCenterAngle();
        return m_controller.isFinished(new double[] {inputDrive, inputTurn}) && System.currentTimeMillis() - m_onTarget > TIME_ON_TARGET;
    }
