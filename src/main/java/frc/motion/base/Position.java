package frc.motion.base;

import jaci.pathfinder.Waypoint;

/**
 * Represent a position in 2D space (for example of a frc.robot) that consists of x, y, and angle (heading, the direction the object faces)
 *
 * @author Alexey
 */
