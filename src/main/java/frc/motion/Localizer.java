...
import frc.motion.base.abstraction.IGyro;
import frc.motion.base.Point;
import frc.motion.base.Position;

import java.util.Timer;
import java.util.TimerTask;

/**
 * runs in a seperate thread calculating the frc.robot position
 *
 * @author Udi & Alexey
 */
public class Localizer extends TimerTask {
    ...
    /**
     * <p>Get the frc.robot location. This is the system: </p>
     * ^<br>
     * |<br>
     * |<br>
     * <--- R
     * <br> <br> Where 'R' is the frc.robot, up is the y coord and left is the x coord
     *
     * @return
     */
